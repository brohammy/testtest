...
export default function Index() {
  ...
  const [disableLibraryValidation, setDisableLibraryValidation] =
    useState(false);
  const [enableDebugging, setEnableDebugging] = useState(false);
  const [enableBackgroundProcessing, setEnableBackgroundProcessing] =
    useState(false);
  const [skipSignatureVerification, setSkipSignatureVerification] =
    useState(false);
  ...
  const isFormValid = () => {
    const hasIpa =
      ipaSource === "file" ? ipaFile !== null : ipaUrl.trim().length > 0;
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (customEntitlements)
        formData.append("entitlements", customEntitlements);
      ...
      if (enableInternalOptions)
        formData.append("enableInternalOptions", "true");
      if (enableInternalStorage)
        formData.append("enableInternalStorage", "true");

      // Add advanced modifications
      if (removeAppRestrictions)
        formData.append("removeAppRestrictions", "true");
      if (enableFileSharing) formData.append("enableFileSharing", "true");
      if (disableLibraryValidation)
        formData.append("disableLibraryValidation", "true");
      if (enableDebugging) formData.append("enableDebugging", "true");
      if (enableBackgroundProcessing)
        formData.append("enableBackgroundProcessing", "true");
      if (skipSignatureVerification)
        formData.append("skipSignatureVerification", "true");
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            Complete signing solution with Cyan modifications and advanced
            options
          </p>
        </div>
                  ...
                  style={{
                    ...
                    boxShadow:
                      ipaSource === "file"
                        ...
                        : "none",
                    transform:
                      ipaSource === "file" ? "translateY(-1px)" : "none",
                  }}
                >
                  Upload File
                </button>
                  ...
                  style={{
                    ...
                    boxShadow:
                      ipaSource === "url"
                        ...
                        : "none",
                    transform:
                      ipaSource === "url" ? "translateY(-1px)" : "none",
                  }}
                >
                  From URL
                </button>
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          {ipaFile
                            ? ipaFile.name
                            : "Choose or drag & drop IPA file (max 5GB)"}
                        </span>
                      </div>
                      <svg
                        style={{
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        {p12File
                          ? p12File.name
                          : "Choose or drag & drop P12 certificate"}
                      </span>
                    </div>
                    <svg
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        {mpFile
                          ? mpFile.name
                          : "Choose or drag & drop mobile provision"}
                      </span>
                    </div>
                    <svg
                      style={{ width: "24px", height: "24px", fill: "#a0aec0" }}
            ...
            {progress?.status === "completed" && progress.result && (
              ...
              >
                ...
                >
                  ...
                  >
                    <strong style={{ color: "#166534" }}>File:</strong>{" "}
                  ...
                  >
                    <strong style={{ color: "#166534" }}>Size:</strong>{" "}
                    {formatFileSize(progress.result.metadata.fileSize)}
                  </p>
                  <p
                    style={{
                      padding: "12px",
                  ...
                  >
                    <strong style={{ color: "#166534" }}>Bundle ID:</strong>{" "}
                  ...
                  >
                    <strong style={{ color: "#166534" }}>Version:</strong>{" "}
